...
1. THE Desktop_Client SHALL 支持 Ctrl+N（或 Cmd+N）创建新片段
2. THE Desktop_Client SHALL 支持 Ctrl+S（或 Cmd+S）保存当前片段
3. THE Desktop_Client SHALL 支持 Ctrl+F（或 Cmd+F）打开搜索框
4. THE Desktop_Client SHALL 支持 Ctrl+C（或 Cmd+C）复制选中的代码
5. THE Desktop_Client SHALL 支持 Ctrl+E（或 Cmd+E）导出当前片段
6. THE Desktop_Client SHALL 支持 Delete 键删除选中的片段
7. THE Desktop_Client SHALL 在设置中显示所有可用的快捷键
8. THE Desktop_Client SHALL 允许用户自定义快捷键绑定
